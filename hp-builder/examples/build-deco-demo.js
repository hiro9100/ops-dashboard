...
const COPY = {
  ...
  cursor: ['カーソル追従', 'ポインタを追いかける丸。中の文字も変えられます。'],
  dots: ['網点', '細かい点の並び。片側だけ濃く残して、反対側へ消していきます。'],
  blur: ['にじむ光', '大きな色のかたまりを3つだけ、輪郭が残らないほど強くぼかします。'],
  grain: ['粒', 'フィルムの粒状感。写真の上でも、地の色の上でも効きます。'],
};
