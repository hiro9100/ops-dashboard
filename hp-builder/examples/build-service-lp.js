  ...
  ['faq', {
    ...
    items: [
      ...
      { q: '作ったサイトはどこに公開できますか？', open: false,
        a: '「公開する」から3つの公開先を選べます。Netlify Drop なら、書き出したフォルダを'
          + '放り込むだけでアドレスがもらえます。GitHub Pages や、お持ちのレンタルサーバーにも'
          + '置けます。手順は1手ずつ画面に出ます。' },
      { q: '公開まで代わりにやってもらえますか？', open: false,
        a: 'そこは正直にお伝えします。このツールはサーバーを持たないので、'
          + '置く操作そのものはご自身に踏んでいただきます。'
          + 'その代わり、どこに何を置くかで迷わないところまでは連れて行きます。' },
      ...
      { q: '作ったデータは他の端末でも開けますか？', open: false,
        a: '開けます。書き出したHTMLが、そのまま控えを兼ねています。'
          + 'スマホで書き出したファイルをパソコンに送って「作ったHTMLを開く」から読み込めば、'
          + '写真も配色も含めて、続きから編集できます。登録もログインも要りません。' },
      { q: '機種変更したら消えませんか？', open: false,
        a: '書き出したHTMLさえ持っていれば消えません。編集の途中経過はブラウザに'
          + '自動保存されますが、そちらは端末を替えると引き継げません。'
          + '区切りがついたところでHTMLを書き出して、手元に置いておいてください。' },
    ],
  }],
