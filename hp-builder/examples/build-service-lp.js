...
const blocks = [
  ...
  ['slotstats', {
    ...
    items: [
      ...
      { value: '10', label: '業種の型' },
      { value: '15', label: 'テンプレート' },
      { value: '28', label: '足せるブロック' },
    ],
  }],
  ...
  ['features', {
    ...
    items: [
      ...
      { title: '公開のしかたが分からない',
        text: '「公開する」を押すと、公開先を選ぶところから最後まで1手ずつ案内します。'
          + '押すボタンもその場に出るので、迷う場所がありません。' },
    ],
  }],
  ...
  ['hscroll', {
    eyebrow: 'TEMPLATES', title: '15種のテンプレート', height: 380,
  ...
  ['faq', {
    ...
    items: [
      { q: 'プログラミングの知識は要りますか？', open: true,
        a: '要りません。文字はプレビューの上で続けて2回押し、写真は枠を押して選ぶだけ。'
          + 'コードを開く場面は一度もありません。' },
      { q: 'どのくらいで形になりますか？', open: false,
        a: '業種をえらび、名前を入れ、写真をえらぶ。この3つで1枚仕上がります。'
          + '写真が手元にあれば数分。無くても、あとから足せます。' },
      { q: '作ったサイトはどこに公開できますか？', open: false,
        a: '「公開」から3つの公開先を選べます。Netlify Drop なら、書き出したフォルダを'
          + '放り込むだけでアドレスが手に入ります。GitHub Pages や、お持ちのレンタルサーバーにも'
          + '置けます。手順は1手ずつ画面に出ます。' },
      { q: '公開まで代わりにやってもらえますか？', open: false,
        a: '正直にお伝えします。このツールはサーバーを持たないので、置く操作そのものは'
          + 'ご自身に踏んでいただきます。その代わり、どこに何を置くかで迷わないところまでは'
          + '連れて行きます。' },
      { q: 'スマホだけで作れますか？', open: false,
        a: '作れます。ブロックを1つ選ぶと、左にページ全体の見取り図、真ん中にそのブロック、'
          + '下半分に直す欄、という形に切り替わります。写真もカメラロールからそのまま。' },
      { q: '写真がないのですが。', open: false,
        a: '写真の無い枠には仮の絵が入ります。まず文章だけで形になります。'
          + '写真は後から差し替えられます。' },
      { q: '作ったデータは他の端末でも開けますか？', open: false,
        a: '開けます。書き出したHTMLが、そのまま控えを兼ねています。'
          + 'スマホで書き出したファイルをパソコンに送り、「保存したファイルを開く」で読み込めば、'
          + '写真も配色もそのまま、つづきから。登録もログインも要りません。' },
      { q: '機種変更したら消えませんか？', open: false,
        a: '書き出したHTMLさえ持っていれば消えません。途中経過はブラウザに控えていますが、'
          + 'そちらは端末を替えると引き継げません。区切りのいいところで「保存」を押し、'
          + '手元に置いておいてください。' },
    ],
  }],
