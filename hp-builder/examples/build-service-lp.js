...
const blocks = [
  ...
  ['slotstats', {
    ...
    items: [
      ...
      { value: '14', label: '配色パレット' },
      { value: '24', label: '文字と要素の動き' },
    ],
  }],
  ...
  ['features', {
    ...
    items: [
      { title: '何を書けばいいか分からない',
        text: 'プロンプトは要りません。テンプレートには業種ごとの文章がすでに入っていて、'
          + '自分の言葉に差し替えるだけで形になります。' },
      { title: '触ると崩れるのが怖い',
        text: '文字はプレビューの上でダブルクリック、写真は枠をタップして選ぶだけ。'
          + '崩れたら Ctrl+Z で戻せます。40回ぶん覚えています。' },
      { title: '公開のしかたが分からない',
  ...
  ['about', {
    eyebrow: '( 01 )', title: '選んで、差し替えるだけ。',
    image: '', reverse: false, bg: 'surface', anchor: 'edit',
    body: 'テンプレートは実物のプレビューで選べます。名前だけの一覧ではありません。\n\n'
