...
.shw-item{
  position:relative;z-index:2;width:clamp(120px,15vw,230px);
...
.shw-shelf{
  ...
  width:min(56%,540px);height:clamp(10px,1.1vw,20px);margin-top:-6px;
  background:linear-gradient(180deg,
    color-mix(in srgb,var(--c-surface) 40%,white) 0 46%,
    color-mix(in srgb,var(--c-surface) 82%,var(--c-text)) 46% 100%);
  box-shadow:0 22px 34px -18px rgba(0,0,0,.45)
}
@supports not (color:color-mix(in srgb,red,blue)){
