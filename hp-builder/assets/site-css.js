...
.shp-round :is(.hero-media,.about-media,.gal figure,.flr-pic,.hs-card,.cpic){
  border-radius:clamp(18px,2.2vw,44px)
}
.shp-circle :is(.hero-media,.about-media,.gal figure,.flr-pic,.hs-card,.cpic){
  clip-path:circle(50% at 50% 50%);aspect-ratio:1/1
}
.shp-arch :is(.hero-media,.about-media,.gal figure,.flr-pic,.hs-card,.cpic){
  border-radius:999px 999px 0 0
}
/* 木の葉：対角の2隅だけを大きく丸める */
.shp-leaf :is(.hero-media,.about-media,.gal figure,.flr-pic,.hs-card,.cpic){
  border-radius:clamp(40px,7vw,140px) 0 clamp(40px,7vw,140px) 0
}
.shp-hex :is(.hero-media,.about-media,.gal figure,.flr-pic,.hs-card,.cpic){
  clip-path:polygon(25% 0,75% 0,100% 50%,75% 100%,25% 100%,0 50%)
}
.shp-slant :is(.hero-media,.about-media,.gal figure,.flr-pic,.hs-card,.cpic){
  clip-path:polygon(0 0,100% 0,100% 88%,0 100%)
}
.shp-egg :is(.hero-media,.about-media,.gal figure,.flr-pic,.hs-card,.cpic){
...
/* ---------- 形をなぞって抜く（デザイン寄り） ----------
   ...
   見本の絵と同じ出かたなので、これでよい。 */
.shp-slats :is(.hero-media,.about-media,.gal figure,.flr-pic,.hs-card,.cpic){
  border-radius:0;
...
.shp-arches :is(.hero-media,.about-media,.gal figure,.flr-pic,.hs-card,.cpic){
  border-radius:0;
...
.shp-wave :is(.hero-media,.about-media,.gal figure,.flr-pic,.hs-card,.cpic){
  border-radius:0;
...
.shp-blob :is(.hero-media,.about-media,.gal figure,.flr-pic,.hs-card,.cpic){
  border-radius:0;
