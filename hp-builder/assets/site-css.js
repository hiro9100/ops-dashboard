...
:is(.hero-media,.about-media,.gal figure,.flr-pic,.hs-card,.cpic,.vid,.exp-l,.car-it,.clip-side,.hero-bg)
  :is(img,video){
  object-position:var(--ix,50%) var(--iy,50%)
}
:is(.hero-media,.about-media,.gal figure,.flr-pic,.hs-card,.cpic,.vid,.exp-l,.car-it,.clip-side) img{
...
/* ==========================================================
   ...
   ========================================================== */
.plt :is(.hero-media,.about-media,.gal figure,.flr-pic,.hs-card,.cpic,.vid){
  padding:var(--pt,5%) var(--pr,5%) var(--pb,5%) var(--pl,5%);
  box-sizing:border-box
}
/* 写真の側は、土台の形につられて角が立つので、少しだけ丸めて収める */
.plt :is(.hero-media,.about-media,.gal figure,.flr-pic,.hs-card,.cpic,.vid) img{
  border-radius:calc(var(--radius) * .55)
}
.plt-dark :is(.hero-media,.about-media,.gal figure,.flr-pic,.hs-card,.cpic,.vid){background:var(--c-dark)}
.plt-primary :is(.hero-media,.about-media,.gal figure,.flr-pic,.hs-card,.cpic,.vid){background:var(--c-primary)}
.plt-accent :is(.hero-media,.about-media,.gal figure,.flr-pic,.hs-card,.cpic,.vid){background:var(--c-accent)}
.plt-surface :is(.hero-media,.about-media,.gal figure,.flr-pic,.hs-card,.cpic,.vid){background:var(--c-surface)}
.plt-white :is(.hero-media,.about-media,.gal figure,.flr-pic,.hs-card,.cpic,.vid){
...
:is(.shp-round,.shp-circle,.shp-arch,.shp-leaf,.shp-hex,.shp-slant,.shp-egg,
  ...
  :is(.hero-media,.about-media,.gal figure,.flr-pic,.hs-card,.cpic,.vid){
  /* 角丸と重ねると形が濁るので、抜くときは角丸を落とす */
  border-radius:0
}
.shp-round :is(.hero-media,.about-media,.gal figure,.flr-pic,.hs-card,.cpic,.vid){
  border-radius:clamp(18px,2.2vw,44px)
}
.shp-circle :is(.hero-media,.about-media,.gal figure,.flr-pic,.hs-card,.cpic,.vid){
  clip-path:circle(50% at 50% 50%);aspect-ratio:1/1
}
.shp-arch :is(.hero-media,.about-media,.gal figure,.flr-pic,.hs-card,.cpic,.vid){
  border-radius:999px 999px 0 0
}
/* 木の葉：対角の2隅だけを大きく丸める */
.shp-leaf :is(.hero-media,.about-media,.gal figure,.flr-pic,.hs-card,.cpic,.vid){
  border-radius:clamp(40px,7vw,140px) 0 clamp(40px,7vw,140px) 0
}
.shp-hex :is(.hero-media,.about-media,.gal figure,.flr-pic,.hs-card,.cpic,.vid){
  clip-path:polygon(25% 0,75% 0,100% 50%,75% 100%,25% 100%,0 50%)
}
.shp-slant :is(.hero-media,.about-media,.gal figure,.flr-pic,.hs-card,.cpic,.vid){
  clip-path:polygon(0 0,100% 0,100% 88%,0 100%)
}
.shp-egg :is(.hero-media,.about-media,.gal figure,.flr-pic,.hs-card,.cpic,.vid){
...
/* ---------- 形をなぞって抜く（デザイン寄り） ----------
   ...
   見本の絵と同じ出かたなので、これでよい。 */
.shp-slats :is(.hero-media,.about-media,.gal figure,.flr-pic,.hs-card,.cpic,.vid){
  border-radius:0;
...
.shp-arches :is(.hero-media,.about-media,.gal figure,.flr-pic,.hs-card,.cpic,.vid){
  border-radius:0;
...
.shp-wave :is(.hero-media,.about-media,.gal figure,.flr-pic,.hs-card,.cpic,.vid){
  border-radius:0;
...
.shp-blob :is(.hero-media,.about-media,.gal figure,.flr-pic,.hs-card,.cpic,.vid){
  border-radius:0;
...
/* 段ちがい */
.shp-step :is(.hero-media,.about-media,.gal figure,.flr-pic,.hs-card,.cpic,.vid){
  border-radius:0;
...
/* 角を四角く欠く */
.shp-notch :is(.hero-media,.about-media,.gal figure,.flr-pic,.hs-card,.cpic,.vid){
  border-radius:0;
...
/* チケット（左右がへこむ） */
.shp-ticket :is(.hero-media,.about-media,.gal figure,.flr-pic,.hs-card,.cpic,.vid){
  border-radius:0;
...
/* 4点のきらめき */
.shp-sparkle :is(.hero-media,.about-media,.gal figure,.flr-pic,.hs-card,.cpic,.vid){
  border-radius:0;
...
/* 丸みのある十字 */
.shp-cross :is(.hero-media,.about-media,.gal figure,.flr-pic,.hs-card,.cpic,.vid){
  border-radius:0;
...
/* 角の丸いひし形 */
.shp-diamond :is(.hero-media,.about-media,.gal figure,.flr-pic,.hs-card,.cpic,.vid){
  border-radius:0;
...
.shp-own :is(.hero-media,.about-media,.gal figure,.flr-pic,.hs-card,.cpic,.vid){
  border-radius:0;
